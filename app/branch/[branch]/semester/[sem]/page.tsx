...
// ─── Subject data ──────────────────────────────────────────────────────────────
// Only Semester 4 is active for all branches. Other sems → Coming Soon.
const ACTIVE_SEM = 4;

type Subject = { id: string; label: string; short: string };

const SEM4_SUBJECTS: Record<string, { theory: Subject[]; lab?: Subject[] }> = {

  // ── CSE-AIML (your branch) ─────────────────────────────────────
  'CSE-AIML': {
    theory: [
      { id: 'DM',        label: 'Discrete Mathematics',                  short: 'DM'     },
      { id: 'ATCD',      label: 'Automata Theory & Compiler Design',     short: 'AT&CD'  },
      { id: 'DBMS',      label: 'Database Management Systems',           short: 'DBMS'   },
      { id: 'IAI',       label: 'Introduction to Artificial Intelligence', short: 'IAI'  },
      { id: 'OOPs-Java', label: 'OOPs through Java',                     short: 'OOPs'   },
    ...
    lab: [
      ...
      { id: 'OOPs-Java-Lab', label: 'OOPs through Java Lab', short: 'OOPs Lab'  },
    ],
  },

  // ── Shared labs for CSE / CSE-DS / IT ────────────────────────
  // (defined once, reused below)
  ...
  // ── CSE-DS (same syllabus as CSE for Sem 4) ───────────────────
  'CSE-DS': {
    theory: [
      { id: 'DAA',       label: 'Design & Analysis of Algorithms',          short: 'DAA'  },
      { id: 'OS',        label: 'Operating Systems',                        short: 'OS'   },
