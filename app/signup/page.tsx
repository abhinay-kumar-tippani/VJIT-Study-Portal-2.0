...
export default function SignupPage() {
  ...
  const [form, setForm]       = useState({ rollNumber: '', name: '', password: '', confirm: '' });
      ...
      >
        <div className="glass-strong rounded-2xl p-10 shadow-2xl">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-secondary text-sm mt-1">Join VJIT Study Portal</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              />
              <p className="text-xs text-muted-custom mt-1">Your college roll number / student ID</p>
            </div>
